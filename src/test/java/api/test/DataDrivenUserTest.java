...
/**
 * Approach : Data Driven TestNG methods Multiple user creation using Data
 * Provder
 * 
 * @author Ganesh
 */
public class DataDrivenUserTest extends ExtentReportManager {

	UsersPayload userLoad;
	Faker fakeDb = new Faker();

	/**
	 * POST- Create New Users through data provider
	 * 
	 * @param userId
	 * @param userName
	 * @param firstName
